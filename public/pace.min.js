      ...
      d = function () {
        for (
          var t,
            ...
            n,
            r = arguments[0],
            s = 2 <= arguments.length ? B.call(arguments, 1) : [],
            o = 0,
            i = s.length;
          o < i;
          o++
    ...
    tt.__super__.constructor.apply(this, arguments),
      (e = function (r) {
        ...
        return (r.open = function (t, e, n) {
          return (
            M(t) && o.trigger('request', { type: t, url: e, request: r }),
            s.apply(r, arguments)
          )
        })
      }),
  ...
  ;(G = Error),
    ...
    (M = function (t) {
      ...
      if (!q.length && P.ajax) {
        ...
        if (((t = t.toUpperCase()), 0 <= Q.call(P.ajax.trackMethods, t)))
          return !0
      }
      return !1
    }),
    ...
    (et.prototype.watch = function (t) {
      ...
      if (!E(t))
        return (
          (n = new ('socket' === e ? r : s)(n, this.complete)),
    ...
    (x = function () {
      ...
      for (
        n = 0, s = (a = null != (i = P.extraSources) ? i : []).length;
        n < s;
        n++
      )
        (A = a[n]), C.push(new A(P))
